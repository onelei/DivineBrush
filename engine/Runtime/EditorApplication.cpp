...
namespace DivineBrush {
    ...
    ImGuiIO* EditorApplication::io = nullptr;
...
//        >3.3	=OpenGL Version
        ...
        // icon
        GLFWimage image;
        DivineBrush::Texture2d::LoadGLFWimage("../Resources/icon.png", &image); // 读取图标
    ...
    void EditorApplication::Run() {
        ...
        Screen::SetScreenSize(display_w, display_h);
        UpdateScreenSize();
    ...
    EMSCRIPTEN_MAINLOOP_BEGIN
...
#endif
        {
            ...
            if (useImGui) {
                ...
                //Game Window
                DivineBrush::Editor::EditorWindow::GUI(io);
